...
It creates wheels for Python versions 3.7, 3.8, 3.9, 3.10 and 3.11.0rc2. In addition it runs ``pytest`` after successfull creation of each wheel.

To be able to run the script ``pyenv`` needs to be installed first including the following Python interpreter versions:

3.7.15 3.8.15 3.9.15 3.10.8 3.11.0rc2
